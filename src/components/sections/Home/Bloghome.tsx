...
export default async function HomeBlogSection({locale,}: HomeBlogSectionProps) {
  ...
  return (
    <section className="bg-background transition-colors pb-3 pt-16">
            ...
            >
              <article className="flex h-full flex-col">
                ...
                <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl bg-muted">
                  ...
                  {/* Arrow */}
                  <div className="absolute bottom-3 right-3 flex h-10 w-10 translate-y-2 items-center justify-center rounded-full bg-white/95 text-heading opacity-0 shadow-lg transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                    <svg
                ...
                <div className="flex flex-1 flex-col pt-2">
                  ...
                  {/* Read article */}
                  <div className="mt-auto flex items-center gap-2 pt-5 text-xs font-semibold uppercase tracking-[0.12em] text-primary transition-colors duration-300 group-hover:text-primary">
                    <span>
